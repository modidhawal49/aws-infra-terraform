...
module "eks" {
  ...
  eks_managed_node_groups = {
    ng_ewec_prod = {
      ...
      desired_size                  = var.eks_ng_ewec_prod_desired
      min_size                      = var.eks_ng_ewec_prod_min
      max_size                      = var.eks_ng_ewec_prod_max
      ...
      iam_role_arn    = "arn:aws:iam::035838344560:role/ng-prod-eks-node-group-2025100308082703580000001f"
      create_launch_template  = false
      vpc_security_group_ids = ["sg-0e64119c7a4599d4e"]
      enabled = false
    }
  }
